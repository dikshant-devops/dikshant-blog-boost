...
// ../.wrangler/tmp/bundle-JuETKV/checked-fetch.js
...
var ContactSchema = external_exports.object({
  name: external_exports.string().min(2, "Name must be at least 2 characters").max(100, "Name is too long"),
  email: external_exports.string().email("Invalid email address").max(255, "Email is too long"),
  subject: external_exports.string().min(3, "Subject must be at least 3 characters").max(200, "Subject is too long"),
  message: external_exports.string().min(10, "Message must be at least 10 characters").max(5e3, "Message is too long"),
  turnstileToken: external_exports.string().min(1, "CAPTCHA verification is required")
});
...
function checkRateLimit(ip, maxRequests, windowMs) {
  ...
  if (existing.count >= maxRequests) {
    const retryAfter = Math.ceil((windowMs - timePassed) / 1e3);
...
// ../.wrangler/tmp/pages-9Xj6vr/functionsRoutes-0.18116931435011874.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-JuETKV/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-JuETKV/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.11996589752047337.mjs.map
